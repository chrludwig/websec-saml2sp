...
import de.chludwig.websec.saml2sp.security.SAMLUserDetailsServiceImpl;
 ...
 */
@Configuration
@ComponentScan("de.chludwig.websec.saml2sp")
@EnableWebMvcSecurity
@EnableGlobalMethodSecurity(securedEnabled = true)
public class SamlSpringSecurityConfig extends WebSecurityConfigurerAdapter {
    @Autowired
    ...
    @Bean
    @Qualifier("idp-wso2-is")
    public ExtendedMetadataDelegate wso2IsExtendedMetadataProvider()
            throws MetadataProviderException, ResourceException {
    ...
    public MetadataGenerator metadataGenerator() {
        ...
        metadataGenerator.setEntityId("urn:demo:www.chludwig.de:websec:saml2sp");
